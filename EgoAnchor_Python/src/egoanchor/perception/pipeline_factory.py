...
def build_quest_pose_pipeline(cfg: SimpleNamespace) -> QuestPosePipeline:
    ...
    return QuestPosePipeline(
        ...
        render_quality_depth_residual_scale=float(_cfg_get(render_quality_cfg, "depth_residual_scale", 2.5)),
        render_quality_depth_enable_structural=bool(_cfg_get(render_quality_cfg, "depth_enable_structural", True)),
        render_quality_depth_structural_max_weight=float(_cfg_get(render_quality_cfg, "depth_structural_max_weight", 0.35)),
        render_quality_depth_structural_iqr_thresh=float(_cfg_get(render_quality_cfg, "depth_structural_iqr_thresh", 0.02)),
        render_quality_depth_core_erode_kernel=int(_cfg_get(render_quality_cfg, "depth_core_erode_kernel", 3)),
