...
class QuestPosePipeline:
    ...
    def __init__(
        ...
        render_quality_depth_residual_scale: float = 2.5,
        render_quality_depth_enable_structural: bool = True,
        render_quality_depth_structural_max_weight: float = 0.35,
        render_quality_depth_structural_iqr_thresh: float = 0.02,
        render_quality_depth_core_erode_kernel: int = 3,
        ...
        self.render_quality_checker = (
            RenderQualityChecker(
                ...
                depth_residual_scale=render_quality_depth_residual_scale,
                depth_enable_structural=render_quality_depth_enable_structural,
                depth_structural_max_weight=render_quality_depth_structural_max_weight,
                depth_structural_iqr_thresh=render_quality_depth_structural_iqr_thresh,
                depth_core_erode_kernel=render_quality_depth_core_erode_kernel,
