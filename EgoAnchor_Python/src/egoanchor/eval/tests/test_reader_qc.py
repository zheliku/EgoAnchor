...
def _write_valid_task(
    ...
    *,
    ...
    """写出一个包含八 variant 和完整生命周期的最小合法 task。"""
    ...
    manifest = {
        ...
        "log_writer_stats": {
            ...
            "unity_admission.jsonl": {"rows_written": 8, "dropped_rows": 0, "write_error": ""},
            "unity_render.jsonl": {"rows_written": 8, "dropped_rows": 0, "write_error": ""},
            "events.jsonl": {
                "rows_written": None,
