...
SHEET_CONTRACTS = (
    ...
    _sheet(
        ...
        + (
            ...
            _column("prediction_horizon_ms", "float", unit="ms"),
            _column("correction_position_residual_m", "float", unit="m"),
            _column("correction_rotation_residual_deg", "float", unit="deg"),
            _column("continuity_reset_count", "int"),
