...
_PAIRED_SUMMARY_COLUMNS = (
    ...
    _column("metric_key"),
    _column("metric_unit"),
    _column("full_median", "float"),
    _column("full_q1", "float"),
    _column("full_q3", "float"),
    _column("ablation_median", "float"),
    _column("ablation_q1", "float"),
    _column("ablation_q3", "float"),
...
_EXP1_LAG_TRADEOFF_COLUMNS = _EXP1_PLOT_CONTEXT_COLUMNS + (
    ...
    _column("lag_residual_mm", "float", unit="mm"),
...
CSV_TABLE_CONTRACTS = (
    ...
    CsvTableContract("exp1_summary", "segment plus summary plot point", ("plot_id", "panel_id", "point_kind", "session_id", "trial_id", "segment_id", "variant_id", "metric_key"), _EXP1_SUMMARY_COLUMNS),
    CsvTableContract("exp2_mechanism_attribution", "component attribution plot row", ("plot_id", "panel_id", "session_id", "scenario_id", "trial_id", "event_id", "component_id", "metric_key"), _PAIRED_DELTA_COLUMNS + (_column("delta_median", "float"), _column("delta_q1", "float"), _column("delta_q3", "float"), _column("full_median", "float"), _column("full_q1", "float"), _column("full_q3", "float"), _column("ablation_median", "float"), _column("ablation_q1", "float"), _column("ablation_q3", "float"), _column("plot_id"), _column("panel_id"))),
