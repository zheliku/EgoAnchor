...
class SegmenterConfigTest(unittest.TestCase):
    ...
    def test_pose_debug_uses_score_window_without_stereo_window(self) -> None:
        ...
        self.assertEqual(cfg.demo.pose.score_window_width, 2008)
        self.assertEqual(cfg.demo.pose.score_window_height, 1236)
        ...
        self.assertEqual(cfg.demo.pose.snapshot_pose_width, 1920)
        self.assertEqual(cfg.demo.pose.snapshot_pose_height, 1282)
        self.assertEqual(cfg.demo.pose.snapshot_score_width, 2008)
        self.assertEqual(cfg.demo.pose.snapshot_score_height, 1236)
        self.assertEqual(cfg.demo.pose.video_output_dir, "data/debug/videos")
        self.assertAlmostEqual(cfg.demo.pose.video_fps, 10.0)
        self.assertFalse(hasattr(cfg.demo.pose, "score_window_max_fps"))
