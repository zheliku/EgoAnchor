...
# Load an image
image = Image.open(
    "/home/zheliku/projects/EgoAnchor/EgoAnchor_Python/data/offline/cube/rgb/00004.png"
)
...
if len(masks) > 0:
    ...
    mask_save_path = "/home/zheliku/projects/EgoAnchor/EgoAnchor_Python/sam3/output_mask.png"
    ...
    combined_save_path = (
        "/home/zheliku/projects/EgoAnchor/EgoAnchor_Python/sam3/output_mask_combined.png"
    )
...
# 保存可视化结果图片
plt.savefig(
    "/home/zheliku/projects/EgoAnchor/EgoAnchor_Python/sam3/output_result.png",
    dpi=150,
    bbox_inches="tight",
)
print(
    "Visualization saved to: /home/zheliku/projects/EgoAnchor/EgoAnchor_Python/sam3/output_result.png"
)
