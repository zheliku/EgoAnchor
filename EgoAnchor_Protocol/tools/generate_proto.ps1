...
function Invoke-PythonProtoGeneration {
    ...
    if (-not (Test-Path (Join-Path $OutputRoot "egoanchor\protocol\v1\__init__.py"))) {
        Set-Content -Path (Join-Path $OutputRoot "egoanchor\protocol\v1\__init__.py") -Value "# generated protocol.v1 package`n" -Encoding UTF8
    }
