...
\textbf{时序反事实重放。} Kalman Predict-to-Now 的 fitted lag / lag-aligned RMSE 为 175~ms / 13.397~mm，Kalman Hermite 为 315~ms / 4.986~mm；停止后的帧间增量 P95 分别为 0.666~mm 与 0.177~mm。后者以约 140~ms 的额外 lag 换取约 8.411~mm 的对齐残差下降；这些数值是可复算的离线反事实，不是独立 runtime 的显著性证据。
