...
% Source CSV SHA-256: 82faed992a729312533f189ff9716b4092736ea5d91720b3a6197ef1c4881762; Stage 3 TeX SHA-256: f4bd077e587c1108e0326d9f3f4585d28a11b457e9b6ae73945994bc38449143; generator: egoanchor.eval.materialize-v1; file: exp1_tables.tex
% 由 egoanchor.eval 自动生成，请勿手工修改本区块。
...
\toprule
System & World P95 ↓ & HP--RMS ↓ & Response ↓ & Trans. residual P95 ↓ & Rot. residual P95 ↓ & Occlusion P95 ↓ \\
\midrule
...
\begin{figure*}[t]
  ...
  \caption{实验一系统行为。A 和 C 分别以统一蓝色点和误差棒比较世界一致性与遮挡失效约束；B 包含全部持续平移 event 散点，并叠加各系统的 event-level median [IQR]。起停响应与停止后稳定性保留在表~\ref{tab:exp1-generated-summary}，避免把不同时间窗口混入同一图。}
...
% Source CSV SHA-256: 82faed992a729312533f189ff9716b4092736ea5d91720b3a6197ef1c4881762; Stage 3 TeX SHA-256: 088a41b668d46e9180a9fa7decb45437d6873f8e6d3a12fcade8d32aca4caf28; generator: egoanchor.eval.materialize-v1; file: exp2_tables.tex
% 由 egoanchor.eval 自动生成，请勿手工修改本区块。
...
\begin{figure*}[t]
  ...
  \caption{实验二机制归因。$\Delta$ 定义为 Ablated $-$ Full；灰线连接同一 event，蓝色点和误差棒分别表示 event-level 配对点与 median [IQR]。A--D 使用各自冻结主指标和独立纵轴；VCD 的候选级 risk--coverage 曲线保留在 Stage 2 审计输出中，不与组件差值混入同一主图。}
