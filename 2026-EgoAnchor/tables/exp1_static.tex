\begin{table}[t]
\centering
\caption{实验一的静态保真度。各单元格按平移/旋转顺序给出片段中位数，三项指标均取P95；箭头标记优劣方向，粗体为各指标在该通道上的最优中位数。分布见图~\ref{fig:exp1-final}(a,\,b)。}
\label{tab:exp1-static}
\begin{tabular}{@{}lccc@{}}
\toprule
方法 & \shortstack{头动泄漏\,$\downarrow$\\mm/$^\circ$} & \shortstack{绝对注册\,$\downarrow$\\mm/$^\circ$} & \shortstack{静止抖动\,$\downarrow$\\mm/$^\circ$} \\
\midrule
