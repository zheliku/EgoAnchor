...
\shortstack[l]{起动转换\\时延 (ms)} & \textbf{157.04} & 263.76 & 333.98 & 510.36 \\
\midrule
\multicolumn{5}{@{}l}{\textit{持续平移}} \\
有效时延 (ms) & \textbf{202.50} & 255.00 & 380.00 & 360.00 \\
\shortstack[l]{时延对齐\\RMSE (mm)} & 18.57 & 17.14 & 15.69 & \textbf{9.12} \\
...
\shortstack[l]{时延对齐\\RMSE (deg)} & 6.09 & 5.84 & 5.55 & \textbf{4.81} \\
