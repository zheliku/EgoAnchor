...
OUT = Path('/mnt/data/egoanchor_polished/figures')
...
# ---------- data ----------
wb_fig = SpreadsheetFile.import_xlsx(Blob.load('/mnt/data/figure_plot_data(1).xlsx'))
wb_exp3 = SpreadsheetFile.import_xlsx(Blob.load('/mnt/data/experiment3_analysis(2).xlsx'))
f2 = wb_fig.worksheets.get_item('Figure2').get_range('A1:K417').values
f3 = wb_fig.worksheets.get_item('Figure3').get_range('A1:K460').values
h2, h3 = f2[0], f3[0]
...
# ---------- teaser crop ----------
src = Image.open('/mnt/data/egoanchor_review/replay_image_0.jpeg').convert('RGB')
...
main = wb_exp3.worksheets.get_item('主结果').get_range('A1:L16').values
