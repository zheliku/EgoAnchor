...
2. **`2026-EgoAnchor/experiment_1_2_analysis_rebuild_plan.md`**（本文档）

   - 包含四阶段架构设计、13个Task的详细实施步骤
   - 这是你的执行蓝图，严格按照它进行
   - 理解为什么要重构、单向数据契约、统计原则
...
2. 本文档全部内容（`2026-EgoAnchor/experiment_1_2_analysis_rebuild_plan.md`）
...
2026-EgoAnchor/experiment_1_2_analysis_rebuild_plan.md。
