...
namespace EgoAnchor.Reliability
{
    ...
    /// 应用仍分别保留在各自层里。
    /// </summary>
    public sealed class AnchorPolicyHost : AnchorPolicyHostBase
    {
        ...
        public override AnchorState State => Controller.State;
        ...
        public override AnchorPolicyDecision AcceptPose(AnchorObservation observation)
        {
        ...
        public override void NotifyReset(double sampleTimeSeconds, string reason)
        {
        ...
        public override void NotifyReacquire(double sampleTimeSeconds, string reason)
        {
        ...
        public override void NotifyPause(double sampleTimeSeconds, string reason)
        {
        ...
        public override void NotifyResume(double sampleTimeSeconds, string reason)
        {
        ...
        public override void Clear(double sampleTimeSeconds, string reason)
        {
