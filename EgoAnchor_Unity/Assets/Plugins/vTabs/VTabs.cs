...
.AppToolbar
{
     background-color: #222222;
        ...
        static void Shortcuts() // globalEventHandler
        {
            ...
            if (EditorWindow.focusedWindow?.GetType() == t_GameView && t_ShortcutIntegrations.GetMemberValue<bool>("ignoreWhenPlayModeFocused") && Application.isPlaying) return;
        ...
        static void UpdateBrowserTitle(EditorWindow browser)
        {
            ...
            void setLockedTitle()
            {
                ...
                if (name.StartsWith("com."))
                    if (UnityEditor.PackageManager.PackageInfo.FindForAssetPath(path) is UnityEditor.PackageManager.PackageInfo packageInfo)
        ...
        public static IEnumerable<Object> allDockAreas => allEditorWindows.Where(r => r.hasFocus && !r.maximized).Select(r => r.GetMemberValue<Object>("m_Parent")).Where(r => r.GetType() == t_DockArea);
        ...
        public static Type t_ShortcutIntegrations = typeof(Editor).Assembly.GetType("UnityEditor.ShortcutManagement.ShortcutIntegration");
