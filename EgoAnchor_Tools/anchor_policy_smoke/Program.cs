...
static partial class Program
{
    ...
    private static int Main()
    {
        ...
        AssertEgoAnchorEstimatorUsesObservedVelocity();
        AssertEgoAnchorEstimatorDampsVelocityAfterObservedStop();
        AssertPolicyHostReportsActualPredictionWindow();
        AssertEstimatorsClampLongPredictionWindow();
        AssertOneEuroStopsFreeRunAfterPredictionCap();
        AssertOneEuroClampsUnsafeInspectorPredictionCap();
        ...
        AssertPolicyHostDoesNotApplyObservedMotionHoldByDefault();
        AssertPolicyHostKeepsRecentObservedMotionMoving();
        AssertRateLimitPreventsSingleFrameJump();
        AssertRateLimitRampsTranslationVelocity();
        AssertRateLimitCatchesFastTranslationQuickly();
        AssertRateLimitAllowsFastControllerRotation();
